...
void mult_m_m_3x3(float result[3][3], const float left[3][3], const float right[3][3]);
void mult_m_m(
  int left_rows, int left_cols, int right_cols,
  float result[left_rows][right_cols],
  const float left[left_rows][left_cols],
  const float right[left_cols][right_cols]
);
void add_m_m(float result[3][3], const float left[3][3], const float right[3][3]);
